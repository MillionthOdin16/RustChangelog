...
public class BaseSubmarine : BaseVehicle, IEngineControllerUser, IEntity, IAirSupply, IPoolVehicle
{
	...
	private float GetWaterSurfaceY()
	{
		...
		WaterLevel.WaterInfo waterInfo = WaterLevel.GetWaterInfo(((Component)this).transform.position, waves: true, this);
	...
	public override void VehicleFixedUpdate()
	{
		...
		if ((Object)(object)driver != (Object)null && primaryFireInput)
		{
			...
			if (IsInWater && TimeSince.op_Implicit(timeSinceTorpedoFired) >= maxFireRate)
			{
				...
				if (BaseMountable.TryFireProjectile(torpedoContainer, (AmmoTypes)1024, torpedoFiringPoint.position, torpedoFiringPoint.forward, driver, 1f, minSpeed, out var _))
				{
