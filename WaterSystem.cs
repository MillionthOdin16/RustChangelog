...
public class WaterSystem : MonoBehaviour
{
	...
	private static Vector3[] emptyShoreMap = (Vector3[])(object)new Vector3[1] { Vector3.one };
	...
	private static float GetHeight_Managed(Vector3 pos)
	{
		...
		{
			Vector3 shore = (((Object)(object)TerrainTexturing.Instance != (Object)null) ? TerrainTexturing.Instance.GetCoarseVectorToShore(uv) : Vector3.zero);
	...
	public static Vector3 GetNormal(Vector3 pos)
	{
		...
		Vector3 val = (((Object)(object)TerrainMeta.WaterMap != (Object)null) ? TerrainMeta.WaterMap.GetNormal(pos) : Vector3.up);
