...
public class CardReader : IOEntity
{
	...
	public void ServerCardSwiped(RPCMessage msg)
	{
		...
		if (!IsPowered() || Vector3Ex.Distance2D(((Component)msg.player).transform.position, ((Component)this).transform.position) > 1f || ((FacepunchBehaviour)this).IsInvoking((Action)GrantCard) || ((FacepunchBehaviour)this).IsInvoking((Action)FailCard))
		{
			return;
		}
