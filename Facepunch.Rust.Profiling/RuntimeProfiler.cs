...
public static class RuntimeProfiler
{
	...
	[ServerVar(Help = "0 = off, 1 = basic, 2 = everything. This will reset all profiling convars, however they can be modified afterwards")]
	...
	public static void dump_profile_recorders(Arg arg)
	{
		...
		foreach (ProfilerRecorderHandle item in list)
		{
			...
			StringBuilder stringBuilder3 = stringBuilder2.Append(((object)(ProfilerCategory)(ref category)).ToString()).Append(",");
			ProfilerMarkerDataUnit unitType = ((ProfilerRecorderDescription)(ref description)).UnitType;
			StringBuilder stringBuilder4 = stringBuilder3.Append(((object)(ProfilerMarkerDataUnit)(ref unitType)).ToString()).Append(",");
			MarkerFlags flags = ((ProfilerRecorderDescription)(ref description)).Flags;
			stringBuilder4.Append(((object)(MarkerFlags)(ref flags)).ToString()).AppendLine();
		}
	...
	private static void SerializeCommon(EventRecord record)
	{
		try
		{
