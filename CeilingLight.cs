...
public class CeilingLight : IOEntity
{
	...
	public void RefreshGrowables()
	{
		...
		Vis.Entities(((Component)this).transform.position + new Vector3(0f, 0f - ConVar.Server.ceilingLightHeightOffset, 0f), ConVar.Server.ceilingLightGrowableRange, list, 512, (QueryTriggerInteraction)2);
