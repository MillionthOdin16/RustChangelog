...
public class BaseEntity : BaseNetworkable, IOnParentSpawning, IPrefabPreProcess
{
	...
	protected void SendNetworkUpdate_Flags()
	{
		...
		try
		{
			...
			if (subscribers != null && subscribers.Count > 0)
			{
				...
				((SendInfo)(ref val3))._002Ector(subscribers);
				Profiler.EndSample();
	...
	public void ForceUpdateTriggers(bool enter = true, bool exit = true, bool invoke = true)
	{
		...
		else if (componentInChildren is BoxCollider)
		{
			...
			OBB obb = default(OBB);
			((OBB)(ref obb))._002Ector(((Component)this).transform.position, ((Component)this).transform.lossyScale, ((Component)this).transform.rotation, new Bounds(val2.center, val2.size));
	...
	public bool IsOlderThan(BaseEntity other)
	{
		...
		NetworkableId val = (NetworkableId)(((_003F?)net?.ID) ?? default(NetworkableId));
