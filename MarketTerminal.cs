...
public class MarketTerminal : StorageContainer
{
	...
	public bool HasPendingOrderFor(uint vendingMachineId)
	{
		...
		return ((list != null) ? List.FindWith<PendingOrder, uint>((IReadOnlyCollection<PendingOrder>)list, (Func<PendingOrder, uint>)((PendingOrder o) => o.vendingMachineId), vendingMachineId, (IEqualityComparer<uint>)null) : null) != null;
	}
	...
	public void CompleteOrder(uint vendingMachineId)
	{
		if (pendingOrders != null)
		{
			int num = List.FindIndexWith<PendingOrder, uint>((IReadOnlyList<PendingOrder>)pendingOrders, (Func<PendingOrder, uint>)((PendingOrder o) => o.vendingMachineId), vendingMachineId);
			if (num < 0)
			{
