...
public static class TransformUtil
{
	...
	public static bool GetGroundInfo(Vector3 startPos, out RaycastHit hitOut, float range, LayerMask mask, Transform ignoreTransform = null)
	{
		...
		if (Physics.Raycast(new Ray(startPos, Vector3.down), ref val, range, LayerMask.op_Implicit(mask)))
		{
			if ((Object)(object)ignoreTransform != (Object)null && ((Object)(object)((Component)((RaycastHit)(ref val)).collider).transform == (Object)(object)ignoreTransform || ((Component)((RaycastHit)(ref val)).collider).transform.IsChildOf(ignoreTransform)))
			{
	...
	public static bool GetGroundInfo(Vector3 startPos, out Vector3 pos, out Vector3 normal, float range, LayerMask mask, Transform ignoreTransform = null)
	{
		...
		foreach (RaycastHit item in list)
		{
			...
			if (!((Object)(object)ignoreTransform != (Object)null) || (!((Object)(object)((Component)((RaycastHit)(ref current)).collider).transform == (Object)(object)ignoreTransform) && !((Component)((RaycastHit)(ref current)).collider).transform.IsChildOf(ignoreTransform)))
			{
