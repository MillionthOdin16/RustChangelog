...
public class ModularCarOven : BaseOven
{
	...
	protected override void SVSwitch(RPCMessage msg)
	{
		...
		if (!((Object)(object)ModuleParent == (Object)null) && ModuleParent.CanBeLooted(msg.player) && !WaterLevel.Test(((Component)this).transform.position))
		{
			base.SVSwitch(msg);
		}
	}
	...
	protected override void OnCooked()
	{
		...
		base.OnCooked();
		if (WaterLevel.Test(((Component)this).transform.position))
		{
			StopCooking();
		}
	}
