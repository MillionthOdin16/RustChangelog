	...
	private class Support
	{
		...
		public StabilityEntity SupportEntity(StabilityEntity ignoreEntity = null)
		{
			...
			for (int i = 0; i < link.connections.Count; i++)
			{
				...
				if (!((Object)(object)stabilityEntity2 == (Object)null) && !((Object)(object)stabilityEntity2 == (Object)(object)parent) && !((Object)(object)stabilityEntity2 == (Object)(object)ignoreEntity) && !stabilityEntity2.isClient && !stabilityEntity2.IsDestroyed && (!(socket is ConstructionSocket constructionSocket) || !constructionSocket.femaleNoStability) && ((Object)(object)stabilityEntity == (Object)null || stabilityEntity2.cachedDistanceFromGround < stabilityEntity.cachedDistanceFromGround))
				{
