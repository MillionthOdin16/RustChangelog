...
public class CombatLog
{
	...
	public void Log(BaseEntity attacker, AttackEntity weapon, BaseCombatEntity hitEntity, string description, Projectile projectilePrefab = null, int projectileId = -1, float healthOld = -1f, HitInfo hitInfo = null)
	{
		...
		val.attacker_id = (((Object)(object)attacker != (Object)null && attacker.net != null) ? attacker.net.ID : 0u);
		val.target_id = (((Object)(object)hitEntity != (Object)null && hitEntity.net != null) ? hitEntity.net.ID : 0u);
	...
	public string Get(int count, uint filterByAttacker = 0u, bool json = false, bool isAdmin = false, ulong requestingUser = 0uL)
	{
		...
		foreach (Event item in storage)
		{
			...
			{
				if ((filterByAttacker != 0 && item.attacker_id != filterByAttacker) || ((Object)(object)activeGameMode != (Object)null && !activeGameMode.returnValidCombatlog && !isAdmin && item.proj_hits > 0))
				{
					continue;
				}
