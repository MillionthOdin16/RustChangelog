...
public abstract class DeployVolume : PrefabAttribute
{
	...
	private static bool CheckFlags(List<Collider> list, DeployVolume volume)
	{
		...
		for (int i = 0; i < list.Count; i++)
		{
			...
			if (((Object)(object)monument != (Object)null && !monument.IsSafeZone && volume.ignore.HasFlag(ColliderInfo.Flags.Monument)) || (!((Object)(object)component == (Object)null) && volume.ignore != 0 && component.HasFlag(volume.ignore)))
			{
				continue;
			}
