...
public class BaseNavigator : BaseMonoBehaviour
{
	...
	public bool PlaceOnNavMesh()
	{
		...
		else
		{
			...
			obj[2] = ((object)(Vector3)(ref position2)).ToString();
			obj[3] = " on area: ";
			obj[4] = DefaultArea;
			Debug.LogWarning((object)string.Concat(obj), (Object)(object)((Component)this).gameObject);
		}
		return flag;
	}
	...
	public bool SetDestination(BasePath path, BasePathNode newTargetNode, float speedFraction)
	{
		...
		if (ReachedPosition(((Component)newTargetNode).transform.position))
		{
			return true;
		}
		BasePathNode closestToPoint = path.GetClosestToPoint(((Component)this).transform.position);
		if ((Object)(object)closestToPoint == (Object)null || (Object)(object)((Component)closestToPoint).transform == (Object)null)
		{
			return false;
		}
		if (AStarPath.FindPath(closestToPoint, newTargetNode, out currentAStarPath, out var _))
		{
			...
			Destination = ((Component)newTargetNode).transform.position;
			return true;
		}
		return false;
	}
	...
	private Vector3 GetNextPathPosition()
	{
		...
		{
			return ((Component)currentAStarPath.Peek()).transform.position;
		}
	...
	protected virtual void UpdatePositionAndRotation(Vector3 moveToPosition, float delta)
	{
		...
		if (CurrentNavigationType == NavigationType.AStar && currentAStarPath != null && currentAStarPath.Count > 0)
		{
			...
			if (ReachedPosition(moveToPosition))
			{
				...
				moveToPosition = ((Component)currentAStarPath.Peek()).transform.position;
			}
		}
