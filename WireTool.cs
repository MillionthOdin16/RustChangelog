...
public class WireTool : HeldEntity
{
	...
	public override bool OnRpcMessage(BasePlayer player, uint rpc, Message msg)
	{
		...
		try
		{
			if (rpc == 678101026 && (Object)(object)player != (Object)null)
			{
				...
				{
					Debug.Log((object)("SV_RPCMessage: " + ((object)player)?.ToString() + " - AddLine "));
				}
	...
	public static bool CanModifyEntity(BasePlayer player, BaseEntity ent)
	{
		...
		return player.CanBuild(((Component)ent).transform.position, ((Component)ent).transform.rotation, ent.bounds);
	}
	...
	public void MakeConnection(RPCMessage msg)
	{
		...
		if (!((Object)(object)iOEntity2 == (Object)null) && !(Vector3.Distance(((Component)baseNetworkable2).transform.position, ((Component)baseNetworkable).transform.position) > maxWireLength) && num < iOEntity.inputs.Length && num2 < iOEntity2.outputs.Length && !((Object)(object)iOEntity.inputs[num].connectedTo.Get() != (Object)null) && !((Object)(object)iOEntity2.outputs[num2].connectedTo.Get() != (Object)null) && (!iOEntity.inputs[num].rootConnectionsOnly || iOEntity2.IsRootEntity()) && CanModifyEntity(player, iOEntity) && CanModifyEntity(player, iOEntity2))
		{
			...
			iOEntity2.outputs[num2].worldSpaceLineEndRotation = ((Component)iOEntity).transform.TransformDirection(iOEntity.inputs[num].handleDirection);
	...
	public void AddLine(RPCMessage msg)
	{
		...
		if (!((Object)(object)iOEntity == (Object)null))
		{
			BaseNetworkable baseNetworkable2 = BaseNetworkable.serverEntities.Find(uid2);
			IOEntity iOEntity2 = (((Object)(object)baseNetworkable2 == (Object)null) ? null : ((Component)baseNetworkable2).GetComponent<IOEntity>());
			if (!((Object)(object)iOEntity2 == (Object)null) && ValidateLine(list, iOEntity, iOEntity2, player, num3) && num2 < iOEntity.inputs.Length && num3 < iOEntity2.outputs.Length && !((Object)(object)iOEntity.inputs[num2].connectedTo.Get() != (Object)null) && !((Object)(object)iOEntity2.outputs[num3].connectedTo.Get() != (Object)null) && (!iOEntity.inputs[num2].rootConnectionsOnly || iOEntity2.IsRootEntity()) && CanModifyEntity(player, iOEntity2) && CanModifyEntity(player, iOEntity))
			{
