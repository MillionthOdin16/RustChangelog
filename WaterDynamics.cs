...
public class WaterDynamics : MonoBehaviour
{
	...
	public struct ImageDesc
	{
		...
		public ImageDesc(Texture2D tex)
		{
			...
			maxWidth = ((Texture)tex).width - 1;
			maxHeight = ((Texture)tex).height - 1;
			widthShift = (int)Mathf.Log((float)((Texture)tex).width, 2f);
		}
	...
	public class Target
	{
		...
		private Texture2D CreateDynamicTexture(int size)
		{
			...
			return new Texture2D(size, size, (TextureFormat)5, false, true)
			{
