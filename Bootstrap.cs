...
public class Bootstrap : SingletonComponent<Bootstrap>
{
	...
	private IEnumerator Start()
	{
		...
		if (!Application.isEditor)
		{
			...
			ExceptionReporter.Disabled = !CommandLine.Full.Contains("-official") && !CommandLine.Full.Contains("-server.official") && !CommandLine.Full.Contains("+official") && !CommandLine.Full.Contains("+server.official");
