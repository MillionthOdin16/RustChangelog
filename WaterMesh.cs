...
public class WaterMesh
{
	...
	public void Initialize(int patchResolution, float patchSizeInWorld, int borderRingCount, float borderRingSpacingFalloff)
	{
		...
		borderVerticesLocal = (Vector3[])(object)new Vector3[borderMesh.vertexCount];
		borderVerticesWorld = (Vector3[])(object)new Vector3[borderMesh.vertexCount];
	...
	public void UpdateBorderMesh(Matrix4x4 centerLocalToWorld, Matrix4x4 borderLocalToWorld, bool collapseCenter)
	{
		...
		else
		{
			...
			{
				borderVerticesWorld[k] = ((Matrix4x4)(ref centerLocalToWorld)).MultiplyPoint3x4(Vector3.zero);
			}
		}
		int l = 1;
		int num5 = num3;
