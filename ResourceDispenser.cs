...
public class ResourceDispenser : EntityComponent<BaseEntity>, IServerComponent
{
	...
	private void GiveResources(BasePlayer entity, float gatherDamage, float destroyFraction, AttackEntity attackWeapon)
	{
		...
		if (Object.op_Implicit((Object)(object)entity))
		{
			...
			Debug.Assert(attackWeapon.ownerItemUID != 0, "Attack Weapon " + ((object)attackWeapon)?.ToString() + " ownerItemUID is 0");
			...
			if ((Object)(object)ownerPlayer != (Object)null)
			{
				...
				Debug.Assert(ownerPlayer.inventory.FindItemUID(attackWeapon.ownerItemUID) != null, "Attack Weapon " + ((object)attackWeapon)?.ToString() + " FindItemUID is null");
			}
		}
	}
